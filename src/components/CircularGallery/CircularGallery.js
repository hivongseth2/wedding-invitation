...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: '/images/Bridge.jpg', text: 'Nếu' },
  { image: '/images/Desk_Setup.jpg', text: 'em' },
  { image: '/images/Waterfall.jpg', text: 'là' },
  { image: '/images/Strawberries.jpg', text: 'bug' },
  { image: '/images/Deep_Diving.jpg', text: 'thì' },
  { image: '/images/Train_Track.jpg', text: 'anh' },
  { image: '/images/Santorini.jpg', text: 'nguyện' },
  { image: '/images/Blurry_Lights.jpg', text: 'crash' },
  { image: '/images/New_York.jpg', text: 'cả đời' }
    ]
